...
/// Spatial memory: location-tagged memories and spatial relationships.
...
impl SpatialMemory {
    ...
    pub fn get_all(&self, user_id: Option<&str>, limit: usize) -> Result<Vec<MemoryItem>> {
        self.store
            .get_memories(user_id, Some(MemoryType::Spatial), limit)
    }
    ...
    pub fn search(
        ...
        self.store
            .search_semantic(query_embedding, k, user_id, Some(MemoryType::Spatial))
    }
}
